#!/bin/bash
# run5.sh — E2E for whiteboard zoom/size inputs + editor resize grips on
# image-to-pdf and image-resize-compressor (smoke5.mjs).
...
EXTS="$BASE/whiteboard/ext,$BASE/image-to-pdf/ext,$BASE/image-resize-compressor/ext"
