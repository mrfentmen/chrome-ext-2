...
EXTS=""
for d in random-fact-generator where-is-iss hacker-news-reader wiki-instant internet-radio-player pokemon-price-ticker yugioh-price-ticker; do
